...
@section('content')
    ...
    @include('layouts.partial.page_breadcrumb_add_edit',  [
        'route'                     => route('payment_system_admin:transactions.index'),
                ...
                <div class="table-scrollable">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>@lang('transactions.details.client')</td>
                                <td>{{ $data['transaction']->client->name }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>{{ $data['transaction']->card_no }}</td>
                            </tr>
                            <tr>
